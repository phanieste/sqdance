...
public class Player implements sqdance.sim.Player {
    ...
    private final int MIN_THRESHOLD = 0, STRANGER_THRESHOLD = 1200, CRAMPED_THRESHOLD = 1520, MAX_THRESHOLD = 40000;

    private final double cell_range = 0.002;
    private final double grid_length = 0.5 + 3 * cell_range;
    private Point[][] grid;
    private int grid_size = 200;
    ...
    public Point[] generate_starting_locations_default() {
        ...
        for (int i = 0 ; i < d ; ++i) {
            if(DEBUG)
                System.out.println(i + " " + (1-(i%2)) + " " + round_table.length + " " + (grid_size * grid_size));
